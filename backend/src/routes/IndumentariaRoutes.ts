...
import { cambiarBloqueoTalla, cambiarEstadoEntrega, configurarRegistroTallas, crearPrenda, entregar, guardarMiTalla, guardarTalla, miIndumentaria, resumenIndumentaria } from "../controllers/IndumentariaController";
const router = Router();
