...
import { obtenerAuditoriaParticipacion } from "../services/AuditoriaParticipacionService";
...
export const auditoriaParticipacion = async (_req: Request, res: Response) => res.json(await obtenerAuditoriaParticipacion());
