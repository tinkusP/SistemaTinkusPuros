...
export default function MisTallasView() {
  ...
  return <main className="min-h-screen bg-[#eee8dc] p-5 dark:bg-[#1f1a1c]">
    <section className="mx-auto max-w-xl rounded-3xl bg-white p-7 shadow dark:bg-[#332B2E]">
      ...
      {talla ? <div className="mt-6 grid gap-4 sm:grid-cols-2"><Talla nombre="Polera" valor={talla.tallaPolera}/><Talla nombre="Chamarra" valor={talla.tallaChamarra}/></div> : <p className="mt-5 rounded-xl border border-amber-300 bg-amber-50 p-4 font-bold text-amber-900">Tus tallas todavía no fueron registradas. Presenta tu QR a Administración.</p>}
