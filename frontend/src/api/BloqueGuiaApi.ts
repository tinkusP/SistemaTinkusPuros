...
export type PendienteBloque = { fraternoId:string; usuarioId:string; nombre:string; ci:string; sexo:"HOMBRE"|"MUJER"|null; telefono?:string; facultad?:string; condicion:string; fechaPrimeraCuota:string|null; primeraCuota:string; tallaPolera:string|null; tallaChamarra:string|null; estado:string; listo:boolean };
