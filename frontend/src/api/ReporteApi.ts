...
export type PersonaTallaCuota = { usuarioId: string; fraternoId: string; nombre: string; ci: string; codigoFraterno: string; sexo: string; telefono: string; whatsapp: string | null; correo: string; roles: string[]; tipoRegistro: string; perfilFraterno: boolean; participante: boolean; estadoInscripcion: string; estadoUsuario: string; bloque: string; asignacion: string; tallaPolera: string | null; tallaChamarra: string | null; estadoTallaPolera: "REGISTRADA" | "SIN REGISTRAR" | "NO APLICA"; estadoTallaChamarra: "REGISTRADA" | "SIN REGISTRAR" | "NO APLICA"; tienePolera: boolean; tieneChamarra: boolean; conTalla: boolean; pendienteTalla: "POLERA" | "CHAMARRA" | "AMBAS" | null; estadoMedicion: string; primeraCuota: "PAGADA" | "PENDIENTE" | "SIN REGISTRO / NO APLICA"; estadoPago: string; verificacionPrimeraCuota: string; montoPrimeraCuota: number; montoRegistradoPrimeraCuota: number; montoVerificadoPrimeraCuota: number; saldoPrimeraCuota: number; montoPagadoPrimeraCuota: number; planPagos: string; numeroCuotas: number; cuotasPagadas: number; cuotasPendientes: number; cuotasPorVerificar: number; montoRegistradoTotal: number; montoVerificadoTotal: number; saldoTotal: number; estadoPagoGeneral: string; fechaUltimoPago: string | null; fechaRegistro: string | null; prioridadSeguimiento: "ALTA" | "MEDIA" | "BAJA"; motivoSeguimiento: string; problemasCalidad: string[]; estadoGeneral: string };
