...
export type PersonaTallaCuota = { usuarioId: string; fraternoId: string; nombre: string; ci: string; codigoFraterno: string; sexo: string; telefono: string; whatsapp: string | null; correo: string; roles: string[]; tipoRegistro: string; perfilFraterno: boolean; estadoUsuario: string; bloque: string; tallaPolera: string | null; tallaChamarra: string | null; estadoTallaPolera: "REGISTRADA" | "SIN REGISTRAR" | "NO APLICA"; estadoTallaChamarra: "REGISTRADA" | "SIN REGISTRAR" | "NO APLICA"; tienePolera: boolean; tieneChamarra: boolean; conTalla: boolean; pendienteTalla: "POLERA" | "CHAMARRA" | "AMBAS" | null; primeraCuota: "PAGADA" | "PENDIENTE" | "SIN REGISTRO / NO APLICA"; montoPrimeraCuota: number; montoPagadoPrimeraCuota: number; estadoGeneral: string };
